...
/**
 * Component EquipmentCreatedToolbar
 * @class EquipmentCreatedToolbar
 *
 * @description
 * Action bar for the equipment-created trend card.
 * Reads granularity state directly from
 * {@link OrganizationDashboardEquipmentCreatedStore} and dispatches updates
 ...
 */
@Component({
  selector: 'app-equipment-created-toolbar',
  templateUrl: './equipment-created-toolbar.component.html',
  imports: [
    ReactiveFormsModule,
    ButtonModule,
    InputGroupModule,
...
export class EquipmentCreatedToolbar {
  //#region Properties
   ...
   * {@link OrganizationDashboardEquipmentCreatedStore.setGranularity} mutation.
   *
   * @access protected
   * @since 2.0.0
   *
  ...
  /**
   * Creates an instance of EquipmentCreatedToolbar.
   *
   * @description
