...
Les issues `listbox`, `option`, `combobox`, `img` et `region` du même relevé
restent hors de ce lot ; elles exigent leur propre examen de sémantique native
et de comportement clavier.
