...
import type { NonConformitySeverity, NonConformityStatus } from '@core/models/inspection';
...
/**
 * Type OrganizationDashboardNonConformitiesResolvedSummaryMetric
 *
 * @description
...
/**
 * Type OrganizationDashboardNonConformitiesResolvedState
 *
 * @description
...
export const OrganizationDashboardNonConformitiesResolvedStore = signalStore(
   ...
   * @since 1.0.0
   */
  withState<OrganizationDashboardNonConformitiesResolvedState>(INITIAL_STATE),
  //#endregion
  ...
  withComputed((store) => ({
     ...
     * Includes resolved non-conformity count with optional period-over-period comparison.
     *
     * @since 1.0.0
     */
