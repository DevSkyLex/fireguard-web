...
const AUDIT_ACTION_LABELS: Record<AuditActionId, string> = {
  ...
  'facility.plan_geometry_changed': $localize`:@@audit.action.facility.plan_geometry_changed:Zone outline changed`,
  'equipment.plan_position_changed': $localize`:@@audit.action.equipment.plan_position_changed:Equipment position changed`,
  ...
  'approval.withdrawn': $localize`:@@audit.action.approval.withdrawn:Approval withdrawn`,
