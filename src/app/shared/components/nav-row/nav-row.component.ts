 ...
 * icon, a truncating label, and optionally a count or a short tag. Marks itself
...
export class NavRow {
   ...
   *
   * @description
   * Short uppercase marker rendered before the count, such as "BETA".
   *
   * @access public
   * @since 1.0.0
   *
   * @type {InputSignal<string | null>}
   */
  public readonly tag: InputSignal<string | null> = input<string | null>(null);
