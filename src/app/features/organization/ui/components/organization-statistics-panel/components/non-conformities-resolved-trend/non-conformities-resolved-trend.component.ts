...
import { TREND_CARD_PT } from '@features/organization/ui/components/organization-statistics-panel/constants';
...
export class NonConformitiesResolvedTrend {
  ...
  private readonly dashboardStore: NonConformitiesResolvedTrendStore =
    inject<NonConformitiesResolvedTrendStore>(NonConformitiesResolvedTrendStore);
