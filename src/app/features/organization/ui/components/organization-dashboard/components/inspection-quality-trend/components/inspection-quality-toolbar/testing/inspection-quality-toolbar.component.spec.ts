...
import { InspectionQualityToolbar } from '../inspection-quality-toolbar.component';
...
describe('InspectionQualityToolbar', () => {
  beforeEach(() => {
  ...
  function createComponent() {
    const fixture = TestBed.createComponent(InspectionQualityToolbar);
