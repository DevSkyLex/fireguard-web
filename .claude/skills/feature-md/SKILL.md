---
name: feature-md
description: How to write or update a FEATURE.md in FireGuard Web — the canonical headings, the four update triggers that make an edit mandatory in the same change, and the line that keeps it normative rather than a file catalog. Use whenever a change touches routes, public APIs, ports, cross-feature dependencies, or an invariant.
---
