...
4. Look up every PrimeNG prop, event, and `[pt]` key through the **primeng MCP** rather than guessing — and flag any PrimeNG 22 → 21.1.9 version skew it hits.
...
If the request is really about rich PrimeNG markup rather than creating the unit, hand it to **fg-primeng-ui** instead and say so.
