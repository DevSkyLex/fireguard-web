    ...
    constructor(e) {
      ...
      for (let n in e) {
        ...
        for (let e in r) {
          ...
          let s = t[n][e].rect;
          a.copy(i.bitmap, o, { x: 0, y: 0 }, { x: s.x + 1, y: s.y + 1 }, i.bitmap);
        }
      }
    ...
    for (let t in f) {
      ...
      for (let e of f[t]) {
        ...
        (t.source !== this.source &&
          V(`layer.source = ${t.source} does not equal this.source = ${this.source}`),
    ...
    if (Object.keys(p).length) {
      ...
      (this.inFlightDependencies.push(e),
        (h = i.sendAsync(
          {
            type: `GG`,
            data: { stacks: p, source: this.source, tileID: this.tileID, type: `glyphs` },
          },
          e,
        )));
    }
    ...
    if (g.length) {
      ...
      (this.inFlightDependencies.push(e),
        (_ = i.sendAsync(
          {
            type: `GI`,
            data: { icons: g, source: this.source, tileID: this.tileID, type: `icons` },
          },
          e,
        )));
    }
    ...
    if (v.length) {
      ...
      (this.inFlightDependencies.push(e),
        (y = i.sendAsync(
          {
            type: `GI`,
            data: { icons: v, source: this.source, tileID: this.tileID, type: `patterns` },
          },
          e,
        )));
    }
...
var ae = class {
    ...
    loadVectorTile(t, n) {
      try {
        return { vectorTile: t.encoding === `mlt` ? new D(n) : new F(new e(n)), rawData: n };
      } catch (e) {
    ...
    async loadTile(e) {
      ...
      try {
        ...
        if (e.etag && e.etag === s.etag)
          return (this.tileState.finishLoading(t), this._getEtagUnmodifiedResult(s, i));
