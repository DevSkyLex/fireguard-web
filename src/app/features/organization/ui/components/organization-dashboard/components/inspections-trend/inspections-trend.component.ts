 ...
 */
@Component({
  selector: 'app-inspections-trend',
  templateUrl: './inspections-trend.component.html',
  imports: [
    TrendCard,
    MenuModule,
    TrendFilterDrawer,
...
export class InspectionsTrend {
   ...
   *
   * @description
   * KPI tile fed to {@link TrendCard}: total inspections with optional
