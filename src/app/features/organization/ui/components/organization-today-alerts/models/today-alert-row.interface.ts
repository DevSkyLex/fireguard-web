...
/**
 * Interface TodayAlertRow
 *
 * @description
 * One line of the landing page's alert strip: a named piece of work waiting on
 * the operator, its size, and how it reads. Built by the page from the backend
 * alert feed, which reports counts only — work the collection can enumerate is
 * rendered as a queue of real interventions instead.
 *
 * @since 2.0.0
 */
