...
import { ChannelActivityHeatmap } from '@features/collaboration/ui/components/channel-activity-heatmap';
...
export class ChannelInfoPanel {
  ...
  protected readonly childLinkBase: Signal<string | null> = computed((): string | null => {
    ...
    return organizationId === null ? null : `/organizations/${organizationId}/workspace/channels`;
  });
  //#endregion
