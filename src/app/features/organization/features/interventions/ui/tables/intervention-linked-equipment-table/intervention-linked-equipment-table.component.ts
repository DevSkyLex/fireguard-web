...
/**
 * Component InterventionLinkedEquipmentTable
 * @class InterventionLinkedEquipmentTable
 *
 * @description
 ...
 */
@Component({
  selector: 'app-intervention-linked-equipment-table',
  ...
  templateUrl: './intervention-linked-equipment-table.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InterventionLinkedEquipmentTable {
  //#region Inputs
  /**
   * Property items
   * @readonly
