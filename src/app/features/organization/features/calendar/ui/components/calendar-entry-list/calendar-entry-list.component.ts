 ...
 * — for an intervention entry only — a link to its workspace. Purely
 * presentational: it takes the entries and the organization to link into,
 * and injects no store or service (`ARCHITECTURE.md` §10.3).
 *
 * @version 1.0.0
 *
 * @example
...
@Component({
  ...
  imports: [RouterLink, HlmBadge, ...HlmItemImports],
