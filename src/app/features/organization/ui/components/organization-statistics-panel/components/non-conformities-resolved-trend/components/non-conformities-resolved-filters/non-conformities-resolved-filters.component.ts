...
import { TrendBaseFiltersForm } from '@features/organization/ui/components/organization-statistics-panel/forms';
import type {
  NonConformityStatusOption,
  NonConformitySeverityOption,
} from '@features/organization/ui/components/organization-statistics-panel/models';
import {
  NON_CONFORMITY_SEVERITY_OPTIONS,
  NON_CONFORMITY_STATUS_OPTIONS,
} from '@features/organization/ui/components/organization-statistics-panel/options';
