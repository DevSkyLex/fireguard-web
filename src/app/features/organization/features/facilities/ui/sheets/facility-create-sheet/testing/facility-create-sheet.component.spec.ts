...
import { FacilityCreateSheet } from '../facility-create-sheet.component';

describe('FacilityCreateSheet', () => {
  let fixture: ComponentFixture<FacilityCreateSheet>;

  beforeEach(async () => {
    TestBed.configureTestingModule({ providers: [provideZonelessChangeDetection()] });

    fixture = TestBed.createComponent(FacilityCreateSheet);
    await fixture.whenStable();
  });

  it('should stay closed until the page opens it', async () => {
    expect(document.querySelector('[data-testid="facility-create-sheet"]')).toBeNull();

    fixture.componentRef.setInput('visible', true);
    await fixture.whenStable();

    expect(document.querySelector('[data-testid="facility-create-sheet"]')).not.toBeNull();
  });
