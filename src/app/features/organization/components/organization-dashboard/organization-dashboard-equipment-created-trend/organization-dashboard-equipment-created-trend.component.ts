...
import { OrganizationDashboardEquipmentCreatedStore } from './organization-dashboard-equipment-created-trend.store';
...
export class OrganizationDashboardEquipmentCreatedTrend {
   ...
   */
  protected readonly dashboardStore: OrganizationDashboardEquipmentCreatedStore = inject<OrganizationDashboardEquipmentCreatedStore>(OrganizationDashboardEquipmentCreatedStore);
