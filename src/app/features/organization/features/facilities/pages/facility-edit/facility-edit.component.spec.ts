...
import { ActiveFacilityStore, FacilityStore } from '@core/stores/facility';
import type { FacilityOutput } from '@core/models/facility';
import type { OrganizationOutput } from '@core/models/organization';
import type { FacilityFormValues } from '@features/organization/features/facilities/forms/facility-form';
...
describe('FacilityEditPage', () => {
  ...
  beforeEach(() => {
    ...
    mockFacilityStore.updateOperation.set({ status: 'idle', data: null });
