...
/**
 * Bottom margin applied to the IntersectionObserver root, so the callback fires
 * *before* the sentinel is fully visible and the request gets a head start.
 */
const SENTINEL_ROOT_MARGIN: string = '200px';
...
export class InfiniteScrollDirective implements AfterViewInit, OnDestroy {
  ...
  public ngAfterViewInit(): void {
    ...
    this.observer = new IntersectionObserver(
      ...
      { rootMargin: `0px 0px ${SENTINEL_ROOT_MARGIN} 0px` },
    );
