---
name: hydra-data-access
description: The HydraApiService contract for FireGuard Web — what a transport service may and may not do, the HydraCollection envelope shape, Input/Output DTO conventions, the error flow across layers, and when a pure data adapter is warranted. Use when writing or reviewing anything under data-access/.
---
