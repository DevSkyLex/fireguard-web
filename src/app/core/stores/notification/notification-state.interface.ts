...
export interface NotificationStoreState {
   ...
   *
   * @description
   * Async operation state for listing notifications. Supports both
   * initial load and load-more pagination.
   *
   * @since 1.0.0
   *
   * @type {CollectionOperation<NotificationOutput, unknown>}
   */
  readonly listOperation: CollectionOperation<NotificationOutput, unknown>;

  /**
   * Property markAsReadOperation
   * @readonly
   *
   * @description
   * Async operation state for marking a single notification as read.
   *
   * @since 1.0.0
   *
   * @type {Operation<NotificationOutput, unknown>}
   */
