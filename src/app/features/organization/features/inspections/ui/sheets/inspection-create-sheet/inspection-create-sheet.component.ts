 ...
 */
@Component({
  selector: 'app-inspection-create-sheet',
  imports: [InspectionCreateForm, UnsavedChangesDialog, ...HlmSheetImports],
  templateUrl: './inspection-create-sheet.component.html',
