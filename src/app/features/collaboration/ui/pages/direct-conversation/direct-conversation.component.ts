...
import type { MessageOutput, ThreadEntry } from '@features/collaboration/models';
import { DirectConversationsStore, MessageThreadStore } from '@features/collaboration/state';
import { MessageComposer, MessageRow } from '@features/collaboration/ui/components';
import { groupThreadMessages } from '@features/collaboration/utils';
import {
...
export class DirectConversationPage {
  ...
  public constructor() {
    ...
    effect((): void => {
      ...
      untracked((): void => {
        this.directConversations.ensureLoaded(organization.id);
        this.directory.ensureLoaded(organization.id);
      });
    });
  }
  //#endregion
