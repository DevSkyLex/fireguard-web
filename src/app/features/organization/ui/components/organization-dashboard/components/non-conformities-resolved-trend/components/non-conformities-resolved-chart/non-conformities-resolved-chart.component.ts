 ...
 * @class NonConformitiesResolvedChart
 *
 * @description
 * Chart section for the non-conformities-resolved trend card.
 ...
 */
@Component({
  selector: 'app-non-conformities-resolved-chart',
  templateUrl: './non-conformities-resolved-chart.component.html',
...
export class NonConformitiesResolvedChart {
   ...
   */
  private readonly store: OrganizationDashboardNonConformitiesResolvedStore =
