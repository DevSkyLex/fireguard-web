...
import { ChannelEditForm, type ChannelEditDraft } from '../../forms/channel-edit-form';

/**
 * Component ChannelEditDialog
...
export class ChannelEditDialog {
   ...
   * @returns {void}
   */
  protected onFormSubmitted(draft: ChannelEditDraft): void {
