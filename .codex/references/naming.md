...
Inspect ARCHITECTURE.md §9.11 and the current tree. Historical counts and legacy filenames
are not evidence of the target convention; do not copy a mismatch into new code.
