...
import { AssistantService } from '@features/collaboration/data-access';
import type {
  AssistantFrame,
...
describe('AssistantStore', () => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: { selectedOrganization: organization.asReadonly() },
        },
      ],
    });
  ...
  beforeEach(() => {
    ...
    granted = true;
    organization = signal<OrganizationOutput | null>({ id: 'org-1' } as OrganizationOutput);
    service = {
  ...
  it('drops the transcript but keeps the panel open when the organization changes', () => {
    ...
    organization.set({ id: 'org-2' } as OrganizationOutput);
    TestBed.tick();
