...
describe('CollaborationDirectNav', () => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: MEMBER_DIRECTORY_PORT, useValue: directory },
        {
          ...
          useValue: { selectedOrganization: signal({ id: 'org-1' }).asReadonly() },
        },
      ],
    });
  ...
  it('should render a row per conversation with the resolved counterpart name', () => {
    ...
    expect(link?.getAttribute('href')).toBe('/organizations/org-1/workspace/direct/dc-1');
  });
  ...
  it('should navigate once the store reports the conversation open', () => {
    ...
    expect(navigate).toHaveBeenCalledWith(['/organizations/org-1/workspace/direct', 'dc-42']);
  });
});
