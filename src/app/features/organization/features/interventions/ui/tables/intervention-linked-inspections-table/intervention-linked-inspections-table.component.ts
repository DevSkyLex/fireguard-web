...
/**
 * Component InterventionLinkedInspectionsTable
 * @class InterventionLinkedInspectionsTable
 *
 * @description
 ...
 */
@Component({
  selector: 'app-intervention-linked-inspections-table',
  imports: [
    DatePipe,
    EmptyState,
    InterventionTag,
  ...
  templateUrl: './intervention-linked-inspections-table.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InterventionLinkedInspectionsTable {
  //#region Inputs
  /**
   * Property items
   * @readonly
