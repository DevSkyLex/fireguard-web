    ...
    withComputed(
      (
        ...
        canReadFacilities: computed<boolean>(() =>
          organizationPermissionService.hasPermission(ORGANIZATION_PERMISSION.FACILITIES_READ),
        ),
      ...
      return {
        loadParams: computed<OrganizationDashboardAssetGrowthParams | undefined>(() => {
          ...
          return {
            ...
            includeFacilities,
            ...baseParams,
            equipmentType: includeEquipment
              ? (store.selectedEquipmentType() ?? undefined)
              : undefined,
            equipmentStatus: includeEquipment
              ? (store.selectedEquipmentStatus() ?? undefined)
              : undefined,
            facilityType: includeFacilities
              ? (store.selectedFacilityType() ?? undefined)
              : undefined,
          };
        }),
      };
