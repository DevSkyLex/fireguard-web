...
import { InspectionCreateSheet } from '../inspection-create-sheet.component';

describe('InspectionCreateSheet', () => {
  let fixture: ComponentFixture<InspectionCreateSheet>;

  beforeEach(async () => {
    TestBed.configureTestingModule({ providers: [provideZonelessChangeDetection()] });

    fixture = TestBed.createComponent(InspectionCreateSheet);
    await fixture.whenStable();
  });

  it('should stay closed until the page opens it', async () => {
    expect(document.querySelector('[data-testid="inspection-create-sheet"]')).toBeNull();

    fixture.componentRef.setInput('visible', true);
    await fixture.whenStable();

    expect(document.querySelector('[data-testid="inspection-create-sheet"]')).not.toBeNull();
  });
